...
import '../styles/pages/EgzersizDetayIki.css';
import YouTube from 'react-youtube';
import Ust from '../components/Ust';

const EgzersizDetay2 = ({ users }) => {
  const [data, setData] = useState([]);
  const [videoId, setVideoId] = useState('uearF2Iorng');
  ...
  return (
    ...
    <div className="egzersizdetay2">
      <div>
        <h2>PROFOSYONEL SEVİYE EGZERSİZ BİLGİLERİ</h2>
        <table>
          <thead>
            <tr>
              <th>Egzersiz Adı</th>
