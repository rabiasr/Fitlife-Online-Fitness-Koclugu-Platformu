...
const BeslenmeDetay2 = ({ users }) => {
  const [data, setData] = useState([]);
  
  useEffect(() => {
    const fetchData = async () => {
      try {
        const querySnapshot = await getDocs(collection(db, 'kilokoruma'));
  ...
  return (
    <div className='dis'>
      <div className="beslenmedetay" style={{ position: 'relative', width: '80%', margin: '20px auto', zIndex: '15' }}>
        <div>
          <h2> KİLO KORUMAK İÇİN UYGUN DİYET LİSTESİ </h2>
