...
const BeslenmeDetay1 = ({ users }) => {
  const [data, setData] = useState([]);
  
  useEffect(() => {
    const fetchData = async () => {
      try {
        const querySnapshot = await getDocs(collection(db, 'kiloalma'));
  ...
  return (
    <div className='dis'>
      <div className="beslenmedetay" style={{ position: 'relative', width: '80%', margin: '20px auto', zIndex: '15' }}>
        <div>
          <h2> KİLO ALMAK İÇİN UYGUN DİYET LİSTESİ </h2>
